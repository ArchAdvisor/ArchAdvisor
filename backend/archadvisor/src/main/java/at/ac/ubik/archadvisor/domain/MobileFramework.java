...
public class MobileFramework extends Technology {
    private MobilePlatform targetPlatform;


    public MobileFramework(Long id, String name, String description, LicenseType license, Set<String> tags, String githubUrl, String documentation, Instant lastUpdated, MobilePlatform mobileFramework) {
        super(id, name, description, license, tags, githubUrl, documentation, lastUpdated);
        this.targetPlatform = mobileFramework;
    }
}
