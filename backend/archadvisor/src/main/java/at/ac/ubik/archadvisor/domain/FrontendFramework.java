...
public class FrontendFramework extends Technology {
    ...
    public FrontendFramework(Long id, String name, String description, LicenseType license, Set<String> tags, String githubUrl, String documentation, Instant lastUpdated) {
