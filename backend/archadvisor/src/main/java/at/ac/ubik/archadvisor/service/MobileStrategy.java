...
@Component
public class MobileStrategy implements IScopeRecommendationStrategy {
    @Override
    public RecommendationResult suggest(RecommendationContext recommendationContext, List<Technology> catalog) {
        return null;
    }
}
